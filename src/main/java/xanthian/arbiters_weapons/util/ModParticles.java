...
public final class ModParticles {
    ...
    public static void registerParticles() {
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(Initialise.MOD_ID, "soul_eater_particle"),
                SOUL_EATER_PARTICLE);
        Registry.register(Registries.PARTICLE_TYPE, new Identifier(Initialise.MOD_ID, "soul_eater_totem_particle"),
                SOUL_EATER_TOTEM_PARTICLE);
    }
}
